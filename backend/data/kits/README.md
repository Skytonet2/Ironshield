...
| `bundled_skills` | Array of skill *categories*, not skill IDs. Bulk-import resolves these to on-chain Skill IDs and writes the BIGINT[] into `agent_kits.bundled_skill_ids`. |
...
- `realtor.json` — Realtor Agent (Phase 10 Tier 4). Skills: scout_fb, scout_jiji, outreach_dm, negotiator, verifier_listing.
